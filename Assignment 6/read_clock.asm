...
;
;File Description: read_clock.asm is a reference from assignment 3. This reads in the CPU info 
;                  of the computer running this program. Then it takes in current CPU tics.
;
