...
;				   or not the input is an integer type. If so, add it into the array, or do not add it if otherwise. To stop inputting
...
section .data
	...
	invalidType db "The last input was invalid and not entered into the array.", 10, 0
...
notAnInt:
	...
	call printf
	pop r8
	jmp startOfLoop				;Loops back to start of loop to try again.
	;===================================================================================================
